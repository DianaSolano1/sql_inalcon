...
insert into t_costos_personal values (1,1,1,40,23),
									(2,2,2,100,23),
									(3,3,1,100,23),
									(4,4,1,100,23);
insert into t_costos_personal values (5,5,1,40,23);
select * from t_costos_personal;

insert into t_costos_directos values (2,'Equipos de Topografia',1,100,23,5500000),
